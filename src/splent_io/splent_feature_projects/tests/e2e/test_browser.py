"""
End-to-end tests for splent_feature_projects.
...
Run with:  splent feature:test splent_feature_projects --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_projects")
    assert "splent_feature_projects" in browser.page_source.lower()
